...
def csvscraper(url):
    ...
    print "Let's print the lines with dividends and splits (check the last",
    print "entry for shares created per share in the split and the second to",
    print "last entry for dividends):"
    for line in IDprices:
